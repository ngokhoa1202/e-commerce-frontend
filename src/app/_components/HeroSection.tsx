...
export default function HeroSection(
  ...
  const title: JSX.Element = (props.currentUserRole === UserRole.Parent)
    ...
    : (
      <div>
        <span className="brand-name text-blue-800 drop-shadow-sm">Fulfill</span> your educational mission
      </div>
    );
  ...
  const facilitySlogan: JSX.Element = (props.currentUserRole === UserRole.Tutor)
    ...
    : (
      <div>
        With our <span className="text-blue-700 drop-shadow">high-quality infrastructure &amp; LMS</span>
      </div>
    );
  ...
  const customerFigure: JSX.Element = (props.currentUserRole === UserRole.Parent)
    ...
    : (
      <p className="text-center mt-2">
        <span className="text-blue-800 font-semibold text-xl">300</span> tutors join us last year
      </p>
    );
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            ...
            <Link href="/pricing" 
              className="text-gray-700 px-4 py-2 rounded-md font-normal hover:underline active:underline focus:underline hover:underline-offset-4 active:underline-offset-8 focus:outline-offset-4 hover:text-gray-900 active:text-gray-900 focus:outline-blue-600">
