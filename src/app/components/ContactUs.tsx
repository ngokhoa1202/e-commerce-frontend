    ...
    <>
      ...
      <section className="flex-1 container mx-auto p-6 text-center md:text-left">
        ...
        <div className="flex flex-wrap gap-8">
          ...
          <form className="bg-white shadow-lg rounded-lg p-6 flex-1">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label
                  htmlFor="firstName"
                  className="block text-gray-700 mb-1 font-bold sm:text-left"
                >
                  First Name
                </label>
                <input
          ...
          {/* Contact Information */}
          <div className="flex flex-col space-y-6 w-full md:w-1/3 mx-auto">
            {/* Email Card */}
            <div className="bg-white shadow-lg rounded-lg p-6 flex items-center space-x-4 text-gray-700">
